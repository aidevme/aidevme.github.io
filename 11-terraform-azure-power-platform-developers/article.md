# Terraform for Power Platform: Azure IaC Guide
...
-   [For Decision Makers: Why Your Organisation Needs This](https://aidevme.com/terraform-azure-power-platform-developers/#h-for-decision-makers-why-your-organisation-needs-this)
    -   [The Business Problem This Solves](https://aidevme.com/terraform-azure-power-platform-developers/#h-the-business-problem-this-solves)
    -   [The Real Cost of Manual Infrastructure Management](https://aidevme.com/terraform-azure-power-platform-developers/#h-the-real-cost-of-manual-infrastructure-management)
    -   [Strategic Benefits for the Organisation](https://aidevme.com/terraform-azure-power-platform-developers/#h-strategic-benefits-for-the-organisation)
    -   [What Does Implementation Actually Require?](https://aidevme.com/terraform-azure-power-platform-developers/#h-what-does-implementation-actually-require)
    -   [Questions to Ask Your Team](https://aidevme.com/terraform-azure-power-platform-developers/#h-questions-to-ask-your-team)
    -   [The Bottom Line](https://aidevme.com/terraform-azure-power-platform-developers/#h-the-bottom-line)
-   [Why Terraform for Power Platform Developers?](https://aidevme.com/terraform-azure-power-platform-developers/#h-why-terraform-for-power-platform-developers)

-   [Prerequisites](https://aidevme.com/terraform-azure-power-platform-developers/#h-prerequisites)
-   [Project Structure](https://aidevme.com/terraform-azure-power-platform-developers/#h-project-structure)

-   [Provider Setup](https://aidevme.com/terraform-azure-power-platform-developers/#h-provider-setup)
-   [Scenarios](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenarios)
    -   [Scenario 1: Azure Key Vault for Custom Connector Secrets](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenario-1-azure-key-vault-for-custom-connector-secrets)
    -   [Scenario 2: Azure Storage Account for Power Automate File Handling](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenario-2-azure-storage-account-for-power-automate-file-handling)
    -   [Scenario 3: Azure Function App as Custom Connector Backend](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenario-3-azure-function-app-as-custom-connector-backend)
    -   [Scenario 4: App Registration for Dataverse Authentication](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenario-4-app-registration-for-dataverse-authentication)
    -   [Scenario 5: Azure API Management for Secure Custom Connectors](https://aidevme.com/terraform-azure-power-platform-developers/#h-scenario-5-azure-api-management-for-secure-custom-connectors)
-   [Outputs Configuration](https://aidevme.com/terraform-azure-power-platform-developers/#h-outputs-configuration)

-   [CI/CD Integration: GitHub Actions](https://aidevme.com/terraform-azure-power-platform-developers/#h-ci-cd-integration-github-actions)
    -   [Setting Up OIDC for GitHub Actions](https://aidevme.com/terraform-azure-power-platform-developers/#h-setting-up-oidc-for-github-actions)
    -   [Complete GitHub Actions Workflow](https://aidevme.com/terraform-azure-power-platform-developers/#h-complete-github-actions-workflow)
-   [CI/CD Integration: Azure DevOps Pipelines](https://aidevme.com/terraform-azure-power-platform-developers/#h-ci-cd-integration-azure-devops-pipelines)
    -   [Multi-Stage Azure DevOps Pipeline](https://aidevme.com/terraform-azure-power-platform-developers/#h-multi-stage-azure-devops-pipeline)
-   [Best Practices for Power Platform Teams](https://aidevme.com/terraform-azure-power-platform-developers/#h-best-practices-for-power-platform-teams)
    -   [Can Terraform manage Power Platform environments directly?](https://aidevme.com/terraform-azure-power-platform-developers/#h-can-terraform-manage-power-platform-environments-directly)
    -   [How do I store Terraform secrets securely in pipelines?](https://aidevme.com/terraform-azure-power-platform-developers/#h-how-do-i-store-terraform-secrets-securely-in-pipelines)
    -   [What’s the difference between Terraform workspaces and separate .tfvars files for environments?](https://aidevme.com/terraform-azure-power-platform-developers/#h-what-s-the-difference-between-terraform-workspaces-and-separate-tfvars-files-for-environments)
    -   [Should I use azurerm v3 or v4?](https://aidevme.com/terraform-azure-power-platform-developers/#h-should-i-use-azurerm-v3-or-v4)
    -   [How do I prevent Terraform from destroying production resources accidentally?](https://aidevme.com/terraform-azure-power-platform-developers/#h-how-do-i-prevent-terraform-from-destroying-production-resources-accidentally)
-   [Official References & Resources](https://aidevme.com/terraform-azure-power-platform-developers/#h-official-references-amp-resources)
    -   [Terraform & HashiCorp](https://aidevme.com/terraform-azure-power-platform-developers/#h-terraform-amp-hashicorp)
    -   [Microsoft Power Platform](https://aidevme.com/terraform-azure-power-platform-developers/#h-microsoft-power-platform)
    -   [Azure Services](https://aidevme.com/terraform-azure-power-platform-developers/#h-azure-services)
    -   [Microsoft Dataverse & Entra ID](https://aidevme.com/terraform-azure-power-platform-developers/#h-microsoft-dataverse-amp-entra-id)
    -   [CI/CD & DevOps](https://aidevme.com/terraform-azure-power-platform-developers/#h-ci-cd-amp-devops)
    -   [Security & Compliance](https://aidevme.com/terraform-azure-power-platform-developers/#h-security-amp-compliance)
-   [About This Repository](https://aidevme.com/terraform-azure-power-platform-developers/#h-about-this-repository)

## For Decision Makers: Why Your Organisation Needs This
...
## Why Terraform for Power Platform Developers?
...
| Azure CLI | Latest | [Install Azure CLI](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest) |
...
**Repository Setup Guide:** For complete first-time setup instructions including service principal configuration, Azure AD permissions, and GitHub secrets, see [docs/pre-checklist.md](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/docs/pre-checklist.md).
...
#   Do NOT add secrets here. Secrets are injected by the pipeline.
...
-   [AzureRM Provider documentation — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs)

-   [AzureAD Provider documentation — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs)

## Scenarios

### Scenario 1: Azure Key Vault for Custom Connector Secrets
...
-   [azurerm\_key\_vault — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault)

-   [Use Key Vault references in Power Platform — Microsoft Learn](https://learn.microsoft.com/en-us/power-apps/maker/data-platform/environmentvariables-azure-key-vault-secrets)

### Scenario 2: Azure Storage Account for Power Automate File Handling
...
-   [azurerm\_storage\_account — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_account)

-   [Azure Blob Storage connector for Power Automate](https://learn.microsoft.com/en-us/connectors/azureblob/)
-   [Azure Storage security best practices](https://learn.microsoft.com/en-us/azure/storage/blobs/security-recommendations)

### Scenario 3: Azure Function App as Custom Connector Backend
...
-   [Create a custom connector from an Azure Function — Microsoft Learn](https://learn.microsoft.com/en-us/connectors/custom-connectors/create-custom-connector-from-function)

-   [azurerm\_windows\_function\_app — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/windows_function_app)
-   [Managed identities for Azure Functions](https://learn.microsoft.com/en-us/azure/app-service/overview-managed-identity?tabs=portal%2Chttp)

### Scenario 4: App Registration for Dataverse Authentication
...
-   [azuread\_application — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs/resources/application)

-   [Register an app to connect to Dataverse — Microsoft Learn](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/walkthrough-register-app-azure-active-directory)
-   [Use OAuth 2.0 with Microsoft Dataverse — Microsoft Learn](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/authenticate-oauth)

### Scenario 5: Azure API Management for Secure Custom Connectors
...
-   [azurerm\_api\_management — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/api_management)

-   [Use Azure API Management with Power Platform — Microsoft Learn](https://learn.microsoft.com/en-us/azure/api-management/export-api-power-platform)
-   [Create a custom connector from an API definition](https://learn.microsoft.com/en-us/connectors/custom-connectors/define-openapi-definition)
...
**Complete OIDC Setup Guide:** For detailed step-by-step instructions including exact Azure CLI commands and troubleshooting, see [docs/pre-checklist.md](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/docs/pre-checklist.md) — Section 2 (Service Principal Setup) and Section 3 (Azure AD Permissions).
        ...
        with:
          script: |
            ...
            github.rest.issues.createComment({
              ...
              body: `##  Terraform Plan — \`${{ github.event.inputs.environment || 'dev' }}\`\n\`\`\`hcl\n${truncated}\n\`\`\``
            });
...
-   [Using OpenID Connect with Azure in GitHub Actions](https://docs.github.com/en/actions/security-for-github-actions/security-hardening-your-deployments/configuring-openid-connect-in-azure)
...
-   [Azure DevOps Environments with approvals and checks](https://learn.microsoft.com/en-us/azure/devops/pipelines/process/environments?view=azure-devops)

## Best Practices for Power Platform Teams
...
**Contributing to this repository.** This article and its companion infrastructure code are open source. If you find improvements, bugs, or have questions, contributions are welcome! Before submitting code changes, all contributors must sign a Contributor License Agreement (CLA) — see [CONTRIBUTING.md](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/CONTRIBUTING.md) for details on the process, coding standards, and commit guidelines.
...
**GitHub Actions:** GitHub Environment secrets or Azure Key Vault–referenced values via the Azure CLI  
**Azure DevOps:** Variable groups linked directly to Azure Key Vault  
Local development: ARM\_CLIENT\_SECRET as a shell environment variable, never in files

Pass secrets to Terraform using -var=”secret=$(SECRET\_VAR)” in the plan/apply commands so they never touch the filesystem.
...
-   [Terraform Documentation — HashiCorp](https://developer.hashicorp.com/terraform/docs)[.](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs)

-   [AzureRM Provider — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs)[.](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs)
-   [AzureAD Provider — Terraform Registry](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs)[.](https://registry.terraform.io/providers/microsoft/power-platform/latest/docs)
...
-   [Terraform Backend: Azure Blob Storage](https://developer.hashicorp.com/terraform/language/settings/backends/azurerm)[.](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/guides/4.0-upgrade-guide)
...
-   [Power Platform ALM Overview — Microsoft Learn](https://learn.microsoft.com/en-us/power-platform/alm/overview-alm)[.](https://learn.microsoft.com/en-us/power-platform/alm/devops-build-tools)

-   [Power Platform Build Tools for Azure DevOps](https://learn.microsoft.com/en-us/power-platform/alm/devops-build-tools)[.](https://github.com/microsoft/powerplatform-actions)
-   [GitHub Actions for Power Platform](https://github.com/microsoft/powerplatform-actions)[.](https://learn.microsoft.com/en-us/connectors/custom-connectors/)

-   [Custom Connectors Overview — Microsoft Learn](https://learn.microsoft.com/en-us/connectors/custom-connectors/)[.](https://learn.microsoft.com/en-us/power-apps/maker/data-platform/environmentvariables)
-   [Environment Variables in Power Platform](https://learn.microsoft.com/en-us/power-apps/maker/data-platform/environmentvariables)[.](https://learn.microsoft.com/en-us/power-apps/maker/data-platform/environmentvariables-azure-key-vault-secrets)
...
-   [Azure Key Vault Overview](https://learn.microsoft.com/en-us/azure/key-vault/general/overview)[.](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction)

-   [Azure Blob Storage Introduction](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction)[.](https://learn.microsoft.com/en-us/azure/azure-functions/functions-overview)
-   [Azure Functions Overview](https://learn.microsoft.com/en-us/azure/azure-functions/functions-overview)[.](https://learn.microsoft.com/en-us/azure/api-management/api-management-key-concepts)

-   [Azure API Management Overview](https://learn.microsoft.com/en-us/azure/api-management/api-management-key-concepts)[.](https://learn.microsoft.com/en-us/entra/identity/managed-identities-azure-resources/overview)
-   [Managed Identities for Azure Resources](https://learn.microsoft.com/en-us/entra/identity/managed-identities-azure-resources/overview)[.](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming)

-   [Azure Resource Naming Conventions (CAF)](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming)[.](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-best-practices/resource-tagging)
...
-   [Microsoft Dataverse Web API Overview](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/webapi/overview)[.](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/walkthrough-register-app-azure-active-directory)

-   [Register an App for Dataverse](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/walkthrough-register-app-azure-active-directory)[.](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/authenticate-oauth)
-   [OAuth 2.0 with Dataverse](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/authenticate-oauth)[.](https://learn.microsoft.com/en-us/entra/identity-platform/app-objects-and-service-principals)
...
-   [Store Terraform State in Azure Storage — Microsoft Learn](https://learn.microsoft.com/en-us/azure/developer/terraform/store-state-in-azure-storage)[.](https://learn.microsoft.com/en-us/azure/developer/terraform/authenticate-to-azure)

-   [Authenticate Terraform to Azure](https://learn.microsoft.com/en-us/azure/developer/terraform/authenticate-to-azure)[.](https://docs.github.com/en/actions/security-for-github-actions/security-hardening-your-deployments/configuring-openid-connect-in-azure)
-   [OIDC for GitHub Actions with Azure](https://docs.github.com/en/actions/security-for-github-actions/security-hardening-your-deployments/configuring-openid-connect-in-azure)[.](https://learn.microsoft.com/en-us/azure/devops/pipelines/library/connect-to-azure?view=azure-devops#create-an-azure-resource-manager-service-connection-using-workload-identity-federation)

-   [Workload Identity Federation — Azure DevOps](https://learn.microsoft.com/en-us/azure/devops/pipelines/library/connect-to-azure?view=azure-devops#create-an-azure-resource-manager-service-connection-using-workload-identity-federation)[.](https://learn.microsoft.com/en-us/azure/devops/pipelines/process/environments?view=azure-devops)
-   [Azure DevOps Environments with Approvals](https://learn.microsoft.com/en-us/azure/devops/pipelines/process/environments?view=azure-devops)[.](https://marketplace.visualstudio.com/items?itemName=ms-devlabs.custom-terraform-tasks)
...
-   [Azure Storage Security Best Practices](https://learn.microsoft.com/en-us/azure/storage/blobs/security-recommendations)[.](https://learn.microsoft.com/en-us/azure/key-vault/general/best-practices)

-   [Azure Key Vault Best Practice](https://learn.microsoft.com/en-us/azure/key-vault/general/best-practices)[.](https://github.com/terraform-linters/tflint)
-   [TFLint — Terraform Linter](https://github.com/terraform-linters/tflint)[.](https://www.checkov.io/)

-   [Checkov — Infrastructure Security Scanner](https://www.checkov.io/)

## About This Repository

This article is part of the **[pp-terraform](https://github.com/aidevme/pp-terraform)** open-source project — production-ready Terraform infrastructure for Power Platform solutions.

-   **GitHub Repository:** [aidevme/pp-terraform](https://github.com/aidevme/pp-terraform)

-   **Additional Documentation:**
    -   [Pre-Deployment Checklist](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/docs/pre-checklist.md) — Complete setup guide including service principal, OIDC, and GitHub configuration
    -   [Architecture Documentation](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/docs/architecture.md) — Infrastructure architecture, module dependencies, Mermaid diagrams, and CI/CD flows
    -   [Runbook](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/docs/runbook.md) — Operational procedures for maintenance and troubleshooting
    -   [Contributing Guide](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/CONTRIBUTING.md) — Contribution guidelines, coding standards, and CLA information
-   **Repository Features:**
...
-   **Contributing:** Contributions welcome! See [CONTRIBUTING.md](https://file+.vscode-resource.vscode-cdn.net/c%3A/aidevme/pp-terraform/CONTRIBUTING.md) for guidelines. All contributors must sign a CLA before code contributions can be merged.

*Found this useful? Share it with your Power Platform team and drop a comment below — I’d love to hear how you’re managing Azure infrastructure alongside your solution deployments.*
...
---
Source: [Terraform for Power Platform Developers: Provision Azure Resources & Automate CI/CD](https://aidevme.com/terraform-azure-power-platform-developers/)